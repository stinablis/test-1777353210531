...
export default function Home() {
  ...
  const products = [{ n: 'test', d: 'Our Test product is a state-of-the-art solution designed to streamline processes, increase efficiency, and reduce costs, offering a unique combination of features, functionality, and user experience. With its advanced technology and intuitive interface, it has become an essential tool for businesses seeking to stay ahead of the competition.', i: 'https://images.pexels.com/photos/7038233/pexels-photo-7038233.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'test', d: 'The Test product is a highly versatile and customizable solution, enabling businesses to tailor it to their specific needs, goals, and objectives. Its flexibility, scalability, and reliability make it an ideal choice for companies looking to drive growth, improve productivity, and enhance customer satisfaction.', i: 'https://images.pexels.com/photos/7038233/pexels-photo-7038233.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'test', d: 'Our Test product is a revolutionary innovation that has transformed the way businesses operate, interact, and engage with their customers. By providing a seamless, personalized, and omnichannel experience, it has become a game-changer in the industry, setting new benchmarks for excellence and performance.', i: 'https://images.pexels.com/photos/17658363/pexels-photo-17658363.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'test', d: 'The Test product is a comprehensive and integrated solution that addresses the complex needs of modern businesses, offering a wide range of features, tools, and capabilities. Its advanced analytics, real-time insights, and data-driven decision-making enable companies to optimize their operations, mitigate risks, and capitalize on new opportunities.', i: 'https://images.pexels.com/photos/16280923/pexels-photo-16280923.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'test', d: 'Our Test product is a groundbreaking solution that has redefined the standards of quality, reliability, and performance in the industry. With its cutting-edge technology, robust architecture, and user-friendly interface, it has become the preferred choice of businesses seeking to drive innovation, growth, and success in an ever-changing market landscape.', i: 'https://images.pexels.com/photos/16280923/pexels-photo-16280923.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body selection:bg-accent/30 selection:text-primary">
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="https://images.pexels.com/photos/7722535/pexels-photo-7722535.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="Hero" className="w-full h-full object-cover" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                At Test, we specialize in delivering high-quality products that cater to a wide range of industries, ensuring customer satisfaction and building long-lasting relationships. Our team of experts is dedicated to providing innovative solutions, leveraging the latest technologies to drive growth and success. With a strong commitment to excellence, we strive to make a positive impact in the market.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">Our vision is to become a leading provider of exceptional products, setting new standards of quality, reliability, and performance in the industry.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">Our mission is to empower businesses and individuals with innovative products, exceptional service, and unparalleled support, fostering a culture of innovation, transparency, and customer-centricity.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">tets</h4>
                  <p className="text-sm text-on-surface-variant">At Test, our first core value, \'tets\', represents our unwavering commitment to integrity, honesty, and transparency in all our interactions, ensuring trust and confidence with our customers, partners, and stakeholders.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">test</h4>
                  <p className="text-sm text-on-surface-variant">Our second core value, \'test\', embodies our passion for innovation, creativity, and continuous improvement, driving us to push boundaries, challenge the status quo, and deliver cutting-edge products that exceed customer expectations.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              <div className="col-span-8 row-span-4 overflow-hidden rounded-xl">
                <img src="https://images.pexels.com/photos/8475194/pexels-photo-8475194.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 1" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://images.pexels.com/photos/34007241/pexels-photo-34007241.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 2" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.pexels.com/photos/34007243/pexels-photo-34007243.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
